export interface Place {
  ...
  imageKeyword: string;
  photoUrl?: string; // Photo URL for the place
  googleSearchUrl?: string; // Google search link
}

export type DistanceLimit = 10 | 30 | 0; // 0 = no limit
...
export interface UserPrefs {
  ...
  distanceLimit: DistanceLimit; // 10km, 30km, or 0 (no limit)
}
