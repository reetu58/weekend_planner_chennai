...
export async function GET(request: NextRequest) {
  ...
  const svg = `
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="600" y="200" text-anchor="middle" fill="#F43F5E" font-size="72" font-weight="bold" font-family="sans-serif">Weekendaa</text>
      ...
      <text x="600" y="500" text-anchor="middle" fill="#F43F5E" font-size="24" font-family="sans-serif">Plan smart. Dodge traffic. Enjoy Chennai.</text>
    </svg>
  `;
