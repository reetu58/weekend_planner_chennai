...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            style={{ filter: 'hue-rotate(190deg) sepia(0.2)' }}
            loading="eager"
          />
        </div>
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#0F172A]/90 via-[#0F172A]/60 to-[#0F172A]" />
        <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,rgba(244,63,94,0.1)_0%,transparent_65%)]" />

        <div className="relative z-10 max-w-5xl mx-auto px-6 flex flex-col items-center text-center mt-12">
          {/* Live badge */}
          <div className="animate-fade-in-down flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#F43F5E]/30 bg-[#F43F5E]/10 text-[#FB7185] text-xs font-bold uppercase tracking-widest mb-8 shadow-[0_0_20px_rgba(244,63,94,0.15)]">
          ...
          <div className="animate-fade-in-up flex flex-col sm:flex-row items-center gap-6 mb-16" style={{ animationDelay: '0.2s' }}>
            <Link
              href="/plan"
              className="group relative px-8 py-4 rounded-full bg-[#F43F5E] text-white font-bold text-lg overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(244,63,94,0.4)] btn-shine chip-press"
            >
            ...
            <span className="text-slate-400 text-sm font-medium">Free · No account needed</span>
          </div>

          {/* Stats bar */}
          <div className="animate-fade-in-up w-full max-w-3xl grid grid-cols-3 gap-px bg-white/10 rounded-2xl p-px overflow-hidden backdrop-blur-md" style={{ animationDelay: '0.35s' }}>
            <div className="bg-[#0F172A]/80 px-4 py-5 flex flex-col items-center justify-center text-center backdrop-blur-xl">
      ...
      {/* ===== PHOTO MARQUEE ===== */}
      <section className="relative py-12 border-y border-white/5 bg-[#0F172A]/50 overflow-hidden">
      ...
      {/* ===== WEATHER + TRAFFIC ===== */}
      <section className="relative -mt-8 z-20 max-w-5xl mx-auto px-6 pb-4">
      ...
      <section id="templates" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-xs font-bold uppercase tracking-[0.25em] text-slate-500 mb-3">Chennai · Weekend Discovery</p>
          <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white mb-4">
            Choose Your Escape.
          </h2>
          <p className="text-slate-400 text-lg max-w-xl mx-auto">Six ways to spend your Chennai weekend, each timed around traffic corridors.</p>
        </div>
      ...
      <section id="preview" className="py-24 relative overflow-hidden bg-[#1E293B]/30 border-y border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
          <div className="lg:col-span-5 order-2 lg:order-1">
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white mb-6">Ordered by geography, not guesswork.</h2>
              ...
              <div className="relative pl-6 space-y-8">
                  ...
                  <div className="bg-white/[0.06] rounded-2xl p-3 border border-white/5 flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-xs text-yellow-400 mt-1">
                        ★ 4.8 <span className="text-slate-400">· Besant Nagar</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="relative -left-[45px] py-2 flex items-center gap-3 z-10">
                  <div className="w-8 h-8 rounded-full bg-[#0F172A] border border-white/10 flex items-center justify-center flex-shrink-0">
                    <svg viewBox="0 0 24 24" className="w-4 h-4 text-slate-300" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M12 5l7 7-7 7" /></svg>
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/[0.06] rounded-2xl p-3 border border-white/5 flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-xs text-yellow-400 mt-1">
                        ★ 4.9 <span className="text-slate-400">· 2 hours rec.</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/[0.06] rounded-2xl p-3 border border-white/5 flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-xs text-yellow-400 mt-1">
                        ★ 4.6 <span className="text-slate-400">· Kovalam Beach</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section id="how-it-works" className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 text-lg">Three steps from idea to navigation link.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-12 relative">
          ...
          {[
            ...
            <div key={step.n} className="relative flex flex-col items-center text-center">
              <div className="absolute -top-12 -left-4 text-[150px] font-black text-white/[0.02] leading-none select-none z-0">{step.n}</div>
              ...
              <p className="text-slate-400 text-sm max-w-xs relative z-10">{step.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-12 px-6 pb-24">
        <div className="max-w-6xl mx-auto bg-[#1E293B] rounded-[3rem] p-12 md:p-20 relative overflow-hidden flex flex-col items-center text-center border border-white/10 shadow-2xl">
          <img
            src="https://images.pexels.com/photos/34260202/pexels-photo-34260202.jpeg?auto=compress&cs=tinysrgb&w=1600&q=80"
            alt="Chennai Beach"
            className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-overlay select-none pointer-events-none"
          />
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <Link
              href="/plan"
              className="inline-block px-10 py-5 rounded-full bg-[#F43F5E] hover:bg-[#E11D48] text-white font-bold text-lg transition-all shadow-[0_0_40px_rgba(244,63,94,0.3)] hover:shadow-[0_0_60px_rgba(244,63,94,0.5)] hover:-translate-y-1 btn-shine chip-press"
            >
