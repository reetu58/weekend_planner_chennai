              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <a
                      ...
                      className="font-bold text-[#1B4965] hover:underline"
                    >
                      {place.name} ↗
                    </a>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <a href={place.googleSearchUrl || `https://www.google.com/search?q=${encodeURIComponent(place.name + ' Chennai')}`}
                      target="_blank" rel="noopener noreferrer"
                      className="text-xs text-[#FFB703] font-medium hover:underline">
                      🔍 Google
                    </a>
