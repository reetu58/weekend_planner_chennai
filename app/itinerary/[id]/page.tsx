    ...
    return (
      <div className="min-h-screen bg-sand flex items-center justify-center">
        <div className="text-center animate-fade-in-up">
          <div className="w-16 h-16 bg-[#1B4965]/5 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <span className="w-8 h-8 border-3 border-[#1B4965]/20 border-t-[#1B4965] rounded-full animate-spin block" />
          </div>
          <p className="text-[#1B4965] font-semibold text-lg">Building your plan...</p>
    ...
    return (
      <div className="min-h-screen bg-sand flex items-center justify-center">
        <div className="text-center animate-fade-in-up">
          ...
          <Link href="/plan" className="inline-flex items-center gap-2 px-6 py-3 bg-[#FFB703] text-[#1B4965] rounded-xl font-bold hover:bg-accent-light transition-colors chip-press">
            Create a new plan
        ...
        <div className="lg:grid lg:grid-cols-5 lg:gap-8">
          ...
          <div className="lg:col-span-3 space-y-5">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-[#1B4965] tracking-tight">Your Weekend Plan</h1>
                <p className="text-sm text-gray-400 mt-1.5 flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-[#1B4965]/5 rounded-md text-[#1B4965] font-medium text-xs">
            ...
            <div className="flex gap-3 pt-8">
              <Link
                href="/plan"
                className="flex-1 text-center py-4 bg-gradient-to-r from-[#1B4965] to-[#2d7da8] text-white rounded-2xl font-semibold hover:shadow-elevated transition-all btn-shine chip-press"
              >
              ...
              <Link
                href="/plan"
                className="flex-1 text-center py-4 border-2 border-[#1B4965] text-[#1B4965] rounded-2xl font-semibold hover:bg-[#1B4965] hover:text-white transition-all chip-press"
              >
                <span className="flex items-center justify-center gap-2">
          ...
          <div className="lg:col-span-2 mt-8 lg:mt-0">
            <div className="lg:sticky lg:top-36">
              <button
                ...
                className="lg:hidden w-full mb-4 py-3.5 bg-white border border-gray-200 rounded-2xl text-[#1B4965] font-semibold shadow-soft hover:shadow-card transition-all chip-press flex items-center justify-center gap-2"
              >
